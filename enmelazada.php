               ...
               <div class="row">
               		...
               		<div class="row">
                        ...
                        <div class="col-xxs-12 col-xs-12 col-sm-12 col-md-12 ulockd-fservice-box style2" style="padding-top: 181px;">
                              <div class="db-thumb">
                              <center>
								<img class="img-responsive img-whp2" src="images/productos/abonos/pollinaza/e enmelazada 220px.png"  alt="e enmelazada 220px.png">	
								</center>		
							</div>
                         </div>
                         </div>
                           <div class="col-md-5 wow fadeInUp" >
                               ...
                               <p style="display: inline;font-size: 16px;">La pollinaza es un subproducto derivado de la producción intensiva del pollo de engorda que se obtiene de la combinación básicamente de las excretas del pollo con cama o base de la caseta, residuos de alimento, plumas y agua. </p>
                                ...
                                <div class="col-md-11" style="padding-top: 30px;margin-left: 40px; ">
                                 <p style="display: inline;font-size: 16px;">Excreta directa de granja avícola, con procesos de molienda y sernido. se incorpora un porcentaje de melaza 
									(4 - 10%) para facilitar el acondicionamiento a sus diferentes usos.
									</p>
                                </div>
                         	</div>
									 ...
									 <div class="container">
								               <div class="row">
								                <div class="col-md-4">
													...
													<br>
													Excreta directa de granja avícola, con procesos de molienda y sernido. se incorpora un porcentaje de melaza 
													(4 - 10%) para facilitar el acondicionamiento a sus diferentes usos.
