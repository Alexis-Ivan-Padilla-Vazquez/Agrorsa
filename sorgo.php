               ...
               <div class="row">
               		...
               		<div class="row">
                        ...
                        <div class="col-xxs-12 col-xs-12 col-sm-12 col-md-12 ulockd-fservice-box style2" style="padding-top: 181px;">
                              <div class="db-thumb">
                              <center>
								<img class="img-responsive img-whp2" src="images/productos/materias/b sorgo 220px.png"  alt="b sorgo 220px.png">	
								</center>		
							</div>
                         </div>
                         </div>
                           <div class="col-md-5 wow fadeInUp">
                               ...
                               <p style="display: inline;font-size: 16px;">Los alimentos balanceados con una correcta combinación de ingredientes cubren los requerimientos nutricionales de un animal. Dicha proporción está en función de su etapa metabólica, edad, peso y actividad. 
                                ...
                                <div class="col-md-11" style="padding-top: 30px;margin-left: 40px; ">
                                 <p style="display: inline;font-size: 16px;">Comparándolo con otro cereal, sabemos que, en general, el sorgo tiene más proteína y menos aceite que el maíz, lo cual se traduciría en un contenido de energía metabolizable ligeramente inferior.
								</p>
                                </div>
                         	</div>
									 ...
									 <div class="container">
								               <div class="row">
								                <div class="col-md-4">
													...
													<br>
													Comparándolo con otro cereal, sabemos que, en general, el sorgo tiene más proteína y menos aceite que el maíz, lo cual se traduciría en un contenido de energía metabolizable ligeramente inferior.
													</p>
										        </div>
										          <div class="col-md-4">
														<p class="lead" style="display: inline;font-size: 16px;color: #42390C;"><br>
														<b> Grano molido cereal:</b><br>
