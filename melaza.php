               ...
               <div class="row">
               		...
               		<div class="row">
                        ...
                        <div class="col-xxs-12 col-xs-12 col-sm-12 col-md-12 ulockd-fservice-box style2" style="padding-top: 181px;">
                              <div class="db-thumb">
                              <center>
								<img class="img-responsive img-whp2" src="images/productos/materias/d melaza 220px.png"  alt="d melaza 220px.png">	
								</center>		
							</div>
                         </div>
                         </div>
                               ...
                               <p style="display: inline;font-size: 16px;">Los alimentos balanceados con una correcta combinación de ingredientes cubren los requerimientos nutricionales de un animal. Dicha proporción está en función de su etapa metabólica, edad, peso y actividad. 
                                ...
                                <div class="col-md-11" style="padding-top: 30px;margin-left: 40px; ">
                                 <p style="display: inline;font-size: 16px;">
									Los azúcares contenidos en la melaza son una fuente energética en la dieta de los animales y mejoran la palatabilidad del alimento balanceado.  
								               ...
								               <div class="row">
								                <div class="col-md-4">
										          ...
										          <div class="col-md-4">
														...
														<b>Derivado de la caña de azúcar en forma mielosa</b><br>
