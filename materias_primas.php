               ...
               <div class="row">
               		...
               		<div class="row">
                        ...
                        <div class="col-xxs-12 col-xs-12 col-sm-12 col-md-12 ulockd-fservice-box style2" style="padding-top: 181px;">
                              <div class="db-thumb">
                              <center>
								<img class="img-responsive img-whp2" src="images/productos/materias/a soya 220px.png"  alt="a soya 220px.png">	
								</center>		
							</div>
                         </div>
                         </div>
                           <div class="col-md-5 wow fadeInUp">
                               ...
                               <p style="display: inline;font-size: 16px;">Los alimentos balanceados con una correcta combinación de ingredientes cubren los requerimientos nutricionales de un animal. Dicha proporción está en función de su etapa metabólica, edad, peso y actividad. 
                                ...
                                <div class="col-md-11" style="padding-top: 30px;margin-left: 40px; ">
                                 <p style="display: inline;font-size: 16px;">La pasta de Soya es la fuente de proteína más importante utilizada en la alimentación animal y es un sub producto del procesamiento del frijol de soya. Más del 90% del frijol de soya producido en el mundo es utilizado en la alimentación de los animales.
								</p>
                                </div>
                         	</div>
									 ...
									 <div class="container">
								               <div class="row">
								                <div class="col-md-4">
													...
													<br>
													La pasta de Soya es la fuente de proteína más importante utilizada en la alimentación animal y es un sub producto del procesamiento del frijol de soya. Más del 90% del frijol de soya producido en el mundo es utilizado en la alimentación de los animales.
													</p>
										        </div>
										          <div class="col-md-4">
